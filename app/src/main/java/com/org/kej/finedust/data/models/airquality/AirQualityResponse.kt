...
fun AirQualityResponse.toAirQuality() = AirQuality(
    ...
    coGrade = response?.body?.measuredValues?.firstOrNull()?.coGrade ?: Grade.UNKNOWN,
    coValue = response?.body?.measuredValues?.firstOrNull()?.coValue ?: "",
    dataTime = response?.body?.measuredValues?.firstOrNull()?.dataTime ?: "",
    khaiGrade = response?.body?.measuredValues?.firstOrNull()?.khaiGrade ?: Grade.UNKNOWN,
    ...
    no2Grade = response?.body?.measuredValues?.firstOrNull()?.no2Grade ?: Grade.UNKNOWN,
    no2Value = response?.body?.measuredValues?.firstOrNull()?.no2Value ?: "",
    o3Flag = response?.body?.measuredValues?.firstOrNull()?.o3Flag ?: 0,
    o3Grade = response?.body?.measuredValues?.firstOrNull()?.o3Grade ?: Grade.UNKNOWN,
    o3Value = response?.body?.measuredValues?.firstOrNull()?.o3Value ?: "",
    pm10Flag = response?.body?.measuredValues?.firstOrNull()?.pm10Flag ?: 0,
    pm10Grade = response?.body?.measuredValues?.firstOrNull()?.pm10Grade ?: Grade.UNKNOWN,
    pm10Grade1h = response?.body?.measuredValues?.firstOrNull()?.pm10Grade1h ?: Grade.UNKNOWN,
    ...
    pm25Grade = response?.body?.measuredValues?.firstOrNull()?.pm25Grade ?: Grade.UNKNOWN,
    pm25Grade1h = response?.body?.measuredValues?.firstOrNull()?.pm25Grade1h ?: Grade.UNKNOWN,
    ...
    so2Grade = response?.body?.measuredValues?.firstOrNull()?.so2Grade ?: Grade.UNKNOWN,
